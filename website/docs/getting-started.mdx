...
<div>
<GitHubButton href="https://github.com/ipavlic/apex-fp" data-icon="octicon-star" data-size="large" data-show-count="true" aria-label="Star ipavlic/apex-fp on GitHub">Star</GitHubButton>
</div>
